...
import name.alatushkin.vkapi.generated.ads.objects.DemoStats
import name.alatushkin.vkapi.generated.ads.objects.GetDemographicsIdsType
import name.alatushkin.vkapi.generated.ads.objects.Period
...
data class AdsGetDemographics(
    ...
    var dateFrom: String,
    var dateTo: String
) : VkMethod<List<DemoStats>>("ads.getDemographics", jacksonTypeRef()),
    UserMethod
