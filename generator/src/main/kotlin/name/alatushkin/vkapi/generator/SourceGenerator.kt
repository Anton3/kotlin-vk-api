...
class SourceGenerator(val basePackage: String) {
    ...
    private fun makeVkResult(typeId: TypeId): TypeId {
        return TypeId("name.alatushkin.vkapi.core.VkMethod", listOf(typeId))
    }
    ...
    private fun makeMethodAccessType(methodSchema: MethodSchema): TypeId? {
        val interfacePackage = "name.alatushkin.vkapi.tokens"
    ...
    private fun objectPropsToClassProps(
        ...
        return properties.mapNotNull { (name, propObj) ->
            ...
            val finalType = when {
                name == "date" && typeId.name == "Long" -> TypeId("name.alatushkin.vkapi.vktypes.VkDate")
                name == "bdate" && typeId.name == "String" -> TypeId("name.alatushkin.vkapi.vktypes.VkBirthDate")
                else -> typeId
            }
    ...
    private fun defineCommonTypes() {
        ...
        typeSpace.registerBuiltin("name.alatushkin.vkapi.tokens.UserMethod")
        typeSpace.registerBuiltin("name.alatushkin.vkapi.tokens.ServiceMethod")
