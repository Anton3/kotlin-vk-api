...
class SourceGenerator(val basePackage: String) {
    ...
    private fun makeVkResult(typeId: TypeId): TypeId {
        return TypeId("name.alatushkin.api.vk.core.VkMethod", listOf(typeId))
    }

    private fun makeVkList(typeId: TypeId): TypeId {
        return TypeId("name.alatushkin.api.vk.vktypes.VkList", listOf(typeId))
    }

    private fun makeVkIterator(typeId: TypeId): TypeId {
        return TypeId("name.alatushkin.api.vk.vktypes.VkIterator", listOf(typeId))
    }
    ...
    private fun objectPropsToClassProps(
        ...
        return properties.mapNotNull { (name, propObj) ->
            ...
            val finalType = when {
                name == "date" && typeId.name == "Long" -> TypeId("name.alatushkin.api.vk.vktypes.VkDate")
                name == "bdate" && typeId.name == "String" -> TypeId("name.alatushkin.api.vk.vktypes.VkBirthDate")
                else -> typeId
            }
    ...
    private fun defineCommonTypes() {
        ...
        typeSpace.registerBuiltin("name.alatushkin.api.vk.vktypes.VkDate")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.vktypes.VkList")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.vktypes.VkIterator")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.vktypes.VkBirthDate")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.core.VkMethod")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.json.successReference")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.tokens.UserMethod")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.tokens.ServiceMethod")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.tokens.UserGroupMethod")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.tokens.UserServiceMethod")
        typeSpace.registerBuiltin("name.alatushkin.api.vk.tokens.UserGroupServiceMethod")
